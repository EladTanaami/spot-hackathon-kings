...
"""
Class acts as a converter from aws to azure elastigroup configs.
"""


class ElastigroupConverter:
    def __init__(self, aws_elastigroup_json, password, user_name):
        self.aws_elastigroup_config = json.loads(aws_elastigroup_json)['group']
    ...
    def from_aws_to_azure_strategy(aws_strategy):
        ...
        azure_strategy = {
            ...
            'onDemandCount': aws_strategy.get('onDemandCount', None),
    ...
    def map_compute(self, aws_compute):
        azure_compute = {
            'os': 'Windows' if aws_compute['product'] == 'Windows (Amazon VPC)' else 'Linux',
            'vmSizes': {
